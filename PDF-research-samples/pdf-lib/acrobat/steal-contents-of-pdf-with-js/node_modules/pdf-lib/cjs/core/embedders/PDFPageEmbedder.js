...
var fullPageBoundingBox = function (page) {
    ...
    var width = mediaBox.lookup(2, PDFNumber_1.default).value() -
        mediaBox.lookup(0, PDFNumber_1.default).value();
    var height = mediaBox.lookup(3, PDFNumber_1.default).value() -
        mediaBox.lookup(1, PDFNumber_1.default).value();
