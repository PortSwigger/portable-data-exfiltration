...
declare class PDFParser extends PDFObjectParser {
    static forBytesWithOptions: (pdfBytes: Uint8Array, objectsPerTick?: number | undefined, throwOnInvalidObject?: boolean | undefined) => PDFParser;
    private readonly objectsPerTick;
    private readonly throwOnInvalidObject;
    private alreadyParsed;
    private parsedObjects;
    constructor(pdfBytes: Uint8Array, objectsPerTick?: number, throwOnInvalidObject?: boolean);
